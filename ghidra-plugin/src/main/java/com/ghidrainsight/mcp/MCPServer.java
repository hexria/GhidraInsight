...
public class MCPServer {
    ...
    private void handleWebSocketConnection(java.net.Socket client) {
        try {
            ...
            WebSocketHandler handler = new WebSocketHandler(client, connectionId);
    ...
    private void handleSSEConnection(java.net.Socket client) {
        try {
            ...
            SSEClient sseClient = new SSEClient(client, clientId);
    ...
    public synchronized void shutdown() {
        ...
        try {
            ...
            if (httpServer != null && !httpServer.isClosed())
                httpServer.close();
            if (wsServer != null && !wsServer.isClosed())
                wsServer.close();
            if (sseServer != null && !sseServer.isClosed())
                sseServer.close();
